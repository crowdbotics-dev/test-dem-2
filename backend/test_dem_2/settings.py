"""
Django settings for test_dem_2 project.
...
WSGI_APPLICATION = 'test_dem_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_dem_2 API",
    "DESCRIPTION": "API documentation for test_dem_2 App",
    "VERSION": "v1",
}
